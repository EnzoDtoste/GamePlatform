...
namespace Domino.Net
{
    public partial class Form1 : Form
    {
        ...
        public void Initialize<F, T>(GenerateFichas<T, Image> generate, Distribute<T, Image> distribute, List<PlayFicha<T, Image>> players, IBoardPrint<T, Image> print,
            PassTurn<T, Image> pass, Winner<T, Image> winner, int InitialHand, params IConditions<T, Image>[] conditions) where F: Ficha<T, Image>
        {
